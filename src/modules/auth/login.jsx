...
.auth-brand {
  ...
  color:#F4F0E8;margin-bottom:6px;text-align:center;
}
.auth-brand span { color:#E8341A; }
.auth-brand-sub {
  font-family:'DM Mono',monospace;font-size:9px;
  letter-spacing:.22em;text-transform:uppercase;
  color:rgba(244,240,232,.35);text-align:center;margin-bottom:32px;
}
...
.auth-heading {
  ...
  color:#F4F0E8;margin-bottom:6px;
}
.auth-subheading {
  font-size:14px;font-weight:300;
  color:rgba(244,240,232,.45);margin-bottom:24px;
}
...
.auth-label {
  ...
  color:rgba(244,240,232,.5);margin-bottom:8px;display:block;
}
...
.auth-input-icon {
  ...
  color:rgba(244,240,232,.35);padding:4px;
  transition:color .2s;
}
...
.auth-btn {
  ...
  background:#E8341A;color:#060607;
...
.auth-or-line {
  flex:1;height:1px;background:rgba(244,240,232,.07);
}
.auth-or-text {
  font-family:'DM Mono',monospace;font-size:9px;
  letter-spacing:.2em;text-transform:uppercase;
...
.auth-google-btn:hover {
  ...
  color:#F4F0E8;background:rgba(244,240,232,.04);
}
...
.auth-footer-box a {
  color:#E8341A;text-decoration:none;
...
.auth-forgot a:hover { color:#E8341A; }
